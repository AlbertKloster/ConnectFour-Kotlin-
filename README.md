...
<b>Example 1:</b> <i>the first player wins by placing four discs in a horizontal row</i>
```
Connect Four
First player's name:
> Paul
...
<b>Example 2:</b> <i>the second player wins by placing four discs in a vertical row</i>
```
Connect Four
First player's name:
> Paul
...
<b>Example 3:</b> <i>the first player wins by placing four discs in a diagonal row</i>
```
Connect Four
First player's name:
> Paul
...
<b>Example 5:</b> <i>plain text board</i>
```
Connect Four
First player's name:
> Paul
